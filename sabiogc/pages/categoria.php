...
<?php if (!isset($_GET['accion'])) { ?> 
	...
	<?php foreach ($resultado as $key => $value) { ?>
		<tr>
			...
			<td>
				<a href='./index.php?page=categoria&categoria='<?= $value['categoria'] ?>'&accion=editar' class='btn btn-primary'>
					<span class='glyphicon glyphicon-pencil'></span>Editar</a> 
				<a href='./index.php?page=categoria&categoria='<?= $value['categoria'] ?>'&accion=eliminar' class='btn btn-danger'><span class='glyphicon glyphicon-remove'></span> Eliminar</a></td>
		</tr>
	<?php } ?>
	</table>
	</div>
...
if (isset($_GET['accion']) && ($_GET['accion'] == "annadir" || $_GET['accion'] == "editar")) { ?>
	<form method='post' action= <?= htmlspecialchars('./index.php?page=categoria') ?>>
		<div class='container'>
			<h3><?= $accion ?></h3>
			<p>
